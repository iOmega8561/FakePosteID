        ...
        GeometryReader { proxy in
            NavigationStack {
                ZStack {
                    ...
                    if colorScheme == .dark {
                        Color(red: 0.0, green: 0.0, blue: 0.0).ignoresSafeArea()
                    ...
                    Rectangle()
                        ...
                        .cornerRadius(30.0)
                        .shadow(color: UIDevice.current.localizedModel == "iPhone" ? .black:Color("PosteYellow"), radius: UIDevice.current.localizedModel == "iPhone" ? 0.0:6.0)
                        .overlay() {
                            Rectangle()
                                .fill(colorScheme == .dark ? Color(red: 0.0, green: 0.0, blue: 0.0):Color(red: 0.949, green: 0.949, blue: 0.971))
                                .overlay() {
